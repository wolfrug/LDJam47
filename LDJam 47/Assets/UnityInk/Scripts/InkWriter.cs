...
/// </summary>
public class ClayStory : Story {
    public ClayStory (string jsonString) : base (jsonString) { }

    /*
        public float timeUntilNextEncounter
        {
            get => (float)variablesState["time_until_next_encounter"];
            set => variablesState["time_until_next_encounter"] = value;
        }

        public string zoneName
        {
            get => (string)variablesState["camp_zone"];
            set => variablesState["camp_zone"] = value;
        }

        public int zoneClayCoeff
        {
            get => (int)variablesState["camp_zone_clayCoeff"];
            set => variablesState["camp_zone_clayCoeff"] = value;
        }

        public int zoneFoodCoeff
        {
            get => (int)variablesState["camp_zone_foodCoeff"];
            set => variablesState["camp_zone_foodCoeff"] = value;
        }

        public int zonePeopleCoeff
        {
            get => (int)variablesState["camp_zone_peopleCoeff"];
            set => variablesState["camp_zone_peopleCoeff"] = value;
        }

        public int zoneDangerCoeff
        {
            get => (int)variablesState["camp_zone_dangerCoeff"];
            set => variablesState["camp_zone_dangerCoeff"] = value;
        }

        public bool isNightTime
        {
            get => (int)variablesState["nightTime"] > 0;
            set => variablesState["nightTime"] = value ? 1 : 0;
        }

        public bool isExhausted
        {
            get => (int)variablesState["exhausted"] > 0;
            set => variablesState["exhausted"] = value ? 1 : 0;
        }

        public bool isRested
        {
            get => (int)variablesState["rested"] > 0;
            set => variablesState["rested"] = value ? 1 : 0;
        }

        public int courage
        {
            get => (int)variablesState["courage"];
            set => variablesState["courage"] = value;
        }

        public int food
        {
            get => (int)variablesState["food"];
            set => variablesState["food"] = value;
        }
        */
}
